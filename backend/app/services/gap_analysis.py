"""
Competency gap-analysis logic. Pulled out of the route so /recommendations
can reuse the same calculation instead of duplicating it.
"""
...
def compute_gaps(current_user: dict) -> dict:
